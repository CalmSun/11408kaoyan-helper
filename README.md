...
<p align="center">
  <img alt="版本" src="https://img.shields.io/badge/version-3.5.4-blue">
...
| 📺 哔哩哔哩在线学习视频（v3.5.3 / v3.5.4） | 学习资料页「哔哩哔哩」模式：扫码 / Cookie 两种登录方式（凭证本地持久化）；我的收藏夹浏览与分页加载；关键词视频搜索（自动领取 buvid 防风控）；个性化推荐（WBI 签名 feed 流）与热门视频推荐换一批 / 加载更多；视频点赞 / 投币 / 收藏一键三连（实时状态回显）；原生播放器弹窗屏幕居中加大、分 P 切换、清晰度选择、备用 CDN 自动切换、相关视频紧凑推荐；播放流经主进程代理并注入 Referer 绕过防盗链，与本地资料功能互不影响 |
